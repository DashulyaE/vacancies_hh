...
def test_save_load():
    ...
    data_to_save = [{'id': '120288679', 'name': 'Программист-разработчик', 'alternate_url': "https://hh.ru/vacancy/120288679"},{'id': '120288777', 'name': 'Программист', 'alternate_url': "https://hh.ru/vacancy/120288777"}]
